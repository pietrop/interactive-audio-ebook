  ...
  return <>
   ...
   <title>Interactive audio ebooks</title>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
            ...
            {chapterId? <Nav.Link href={`${basePath}/books/${bookId}/${chapterId-1}`}>Previous Chapter</Nav.Link> :null}
            {chapterId? <Nav.Link href={`${basePath}/books/${bookId}/${chapterId+1}`}>Next Chapter</Nav.Link> :null}
            </Nav>
        </Navbar.Collapse>
        </Navbar>
        <br/><br/><br/><br/>
