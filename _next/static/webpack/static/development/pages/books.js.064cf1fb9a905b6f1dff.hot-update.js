...
function Books() {
  ...
  pids.forEach(function (pid) {
    getData(pid).then(function (res) {
      console.log('res', res); //  booksData.push(res)
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("h2", {
    ...
    }, " ", booksData && booksData.title), __jsx(react_bootstrap_Card__WEBPACK_IMPORTED_MODULE_6__["default"].Text, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 43,
    ...
    }, "Description", booksData && JSON.stringify(booksData))))), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 51,
...
//# sourceMappingURL=books.js.064cf1fb9a905b6f1dff.hot-update.js.map